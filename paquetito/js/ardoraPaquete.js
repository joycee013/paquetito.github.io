...
taboaContidos[0]=new act("Ordenar Frases","Ordenar Frases","","<object width='100%' height='420' type='text/html' data='Ordenar_frases/Ordenar_frases.htm'></object>",false,"",true,true,true);
taboaContidos[1]=new act("Colorear según leyenda","Colorear según leyenda","","<object width='100%' height='420' type='text/html' data='Elementos/Elementos.htm'></object>",false,"",true,true,true);
taboaContidos[2]=new act("Ordenar oraciones","Ordenar oraciones","","<object width='100%' height='420' type='text/html' data='oraciones/oraciones.htm'></object>",false,"",true,true,true);
